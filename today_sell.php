...
<section id="main-content">
	<section class="wrapper">
						...
						<div class="agileinfo-grap">
							<div class="agileits-box">
								<header class="agileits-box-header clearfix">
									<h1 align="center">Today's Sell</h1>
										<div class="toolbar">
      ...
      <table width="100%" border="1" class="table-hover table-bordered table-responsive">
		...
		$cdt=date('Y-m-d');
		$q=mysqli_query($cc,"select * from invoice_tbl where bill_date='$cdt'")or die ("QF");
		while($data=mysqli_fetch_array($q))
		{
			$p=$data['pid'];
			$q1=mysqli_query($cc,"select company_name from  product_tbl where pid=$p" )or die ("QF1");
