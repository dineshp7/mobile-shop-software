...
if(isset($_SESSION['m_a'])=="")
{
	...
	$u=$_REQUEST['edit'];
	$q=mysqli_query($cc,"select * from product_tbl where pid='$u'")or die ("QF1");
	...
	//file consept
		...
		mysqli_query($cc,"update product_tbl set company_name='$cn',product_name='$pn',network='$net',color='$col',seriese='$sr',ram='$rm',rom='$ro',camera='$cm',purchase_price='$per',selling_price='$sel',p_quantity='$pq',battery='$bt',processer='$ps',processer='$beb',weight='$we',photo_1='$fn1',photo_2='$fn2',photo_3='$fn3',description='$des',screen_size='$ss',blootuth_virsion='$bv',garanty='$get',warentey='$wer' where pid='$u'")or die ("QF2");
	...
	<section class="wrapper">
						...
						<div class="agileinfo-grap">
							<div class="agileits-box">
								<header class="agileits-box-header clearfix">
									<h1 align="center">View Product-Update</h1>
										<div class="toolbar">
      ...
      <table width="50%" border="1" align="center" class="table-hover table-bordered table-responsive">
        <tr>
          <td>Company Name </td>
          <td>:</td>
          <td><input name="cn" type="text" id="cn" autofocus="autofocus" placeholder="Enter Company Name"  value="<?php echo $data['company_name'];?>" onKeyPress="return (event.charCode > 64 && 
	event.charCode < 91) || (event.charCode > 96 && event.charCode < 123 || event.charCode==32) " /></td>
        </tr>
        <tr>
          <td>Product Name </td>
          <td>:</td>
          <td><input name="pn" type="text" id="pn" placeholder="Product Name" value="<?php echo $data['product_name'];?>" onKeyPress="return (event.charCode > 64 && 
	event.charCode < 91) || (event.charCode > 96 && event.charCode < 123 || event.charCode==32) "  /></td>
        </tr>
        <tr>
          <td>Network</td>
        ...
        <tr>
          ...
          <td>:</td>
          <td><input name="per" type="text" id="per" placeholder="Purchase Price" value="<?php echo $data['purchase_price'];?>" onKeyPress="return (event.charCode >= 48 && 
	event.charCode <= 57)"  /></td>
        </tr>
        <tr>
          <td>Selling_Price</td>
          <td>:</td>
          <td><input name="sel" type="text" id="sel" placeholder="Selling Price" value="<?php echo $data['selling_price'];?>" onKeyPress="return (event.charCode >= 48 && 
	event.charCode <= 57)" /></td>
        </tr>
        <tr>
          <td>P_Quentity</td>
          <td>:</td>
          <td><input name="pq" type="text" id="pq" placeholder="P Quentity" value="<?php echo $data['p_quantity'];?>" onKeyPress="return (event.charCode >= 48 && 
	event.charCode <= 57)"  /></td>
        </tr>
        <tr>
          <td>Bettery</td>
