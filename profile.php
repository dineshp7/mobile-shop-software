...
$q=mysqli_query($cc,"select * from admin_tbl where aid=$a")or die ("QF");
	...
	<section class="wrapper">
      ...
      <table width="50%" border="1" align="center" class="table-hover table-bordered table-responsive">
        ...
        <tr>	
          <td>Photo</td>
          <td>:</td>
          <td><img src="admin_photo/<?php echo $data['a_photo'];?>?url=admin_photo/<?php echo $data['a_photo'];?>" width="100" height="100" class="dg-picture-zoom" style="border-radius:100%" /></td>
        </tr>
        <tr>
          <td>Login ID </td>
          <td>:</td>
        ...
        <tr>
          <td colspan="3"><div align="center"><a href="edit_profile.php">Edit Profile </a></div></td>
          </tr>
      </table>
        </form>
