	...
	<section class="wrapper">
      ...
      <table width="100%" border="1" class="table-hover table-bordered table-responsive">
        ...
        <tr>
          ...
          <td><em><?php echo $data['company_name'];?></em></td>
          <td><em><?php echo $data['product_name'];?></em></td>
          <td><em><?php echo $data['ram'];?></em></td>
          <td><em><?php echo $data['rom'];?></em></td>
          <td><em><?php echo $data['camera'];?></em></td>
          <td><em><?php echo $data['purchase_price'];?></em></td>
          <td><em><?php echo $data['selling_price'];?></em></td>
          <td><img src="mphoto/<?php echo $data['photo_1'];?>?url=mphoto/<?php echo $data['photo_1'];?>" width="50" height="50" class="dg-picture-zoom style1" /></td>
          <td><a href="create_invoice.php?a=<?php echo $data['pid'];?>"><em><img src="add1.png" width="50" height="40"></em></a></td>
          </tr>
		<?php
		$no++;
		} 
