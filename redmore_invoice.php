						...
						<div class="agileinfo-grap">
							<div class="agileits-box">
								<header class="agileits-box-header clearfix">
									<h1 align="center">Invoice Detail </h1>
										<div class="toolbar">
										  <table width="80%" border="1" align="center" class="table-hover table-bordered table-responsive">
                                            <tr>
                                              <td width="22%">Product Name </td>
                                              <td width="4%">:</td>
                                              <td width="74%"><?php echo $data['product_name'];?></td>
                                            </tr>
                                            <tr>
                                              <td>Price</td>
                                              <td>:</td>
